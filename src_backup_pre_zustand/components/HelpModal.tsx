              ...
              <div className="settings-section">
                ...
                <div className="shortcut-grid">
                  ...
                  <div className="help-shortcut-item">
                    ...
                    <div className="desc">Toggle Solo / Immersive Mode (Focused Unit)</div>
                  </div>
                  <div className="help-shortcut-item">
                    <div className="keys"><kbd>ESC</kbd></div>
                    <div className="desc">Close Active Overlay / Exit Solo Mode</div>
                  </div>
                  <div className="help-shortcut-item">
                    <div className="keys"><kbd>▲</kbd> / <kbd>▼</kbd></div>
                    <div className="desc">Navigate Previous / Next Unit (Solo/Immersive)</div>
                  </div>
                  <div className="help-shortcut-item">
                    <div className="keys"><kbd>◀</kbd> / <kbd>▶</kbd></div>
                ...
                <div className="interaction-list">
                  <div className="interaction-item">
                    ...
                    <div className="i-content">
                      ...
                      <span>Double click any media card to instantly enter "Deep Focus" solo fullscreen mode.</span>
                    </div>
                  </div>
                  <div className="interaction-item">
